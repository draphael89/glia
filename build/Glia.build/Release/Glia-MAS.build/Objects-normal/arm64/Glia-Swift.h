...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Glia",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSEvent;
@protocol MTLDevice;
SWIFT_CLASS("_TtC4Glia12GraphMTKView")
@interface GraphMTKView : MTKView
...
SWIFT_CLASS("_TtC4Glia13GraphRenderer")
@interface GraphRenderer : NSObject <MTKViewDelegate>
