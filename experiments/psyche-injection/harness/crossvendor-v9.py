#!/usr/bin/env python3
"""Cross-vendor judge (gpt-5) on the v9 PRODUCTION-pipeline answers — does a
non-Anthropic frontier model also find the SHIPPED prime_context injection helps?
Judges the fixed v9 answers blind (only ANSWERS go to OpenAI, never the psyche —
same privacy boundary as v6). Writes results/raw/results-v9-gpt5.json.
"""
